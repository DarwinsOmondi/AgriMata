...
@Composable
fun CreateFarmerAccount(onSuccess: () -> Unit, authViewModel: FarmersAuthViewModel) {
    ...
    val clientAuthViewModel: AgriMataClientAuth = viewModel()
            ...
            Box(
                ...
                Column(
                    ...
                    Box(
                        ...
                        Text(
                            text = "Sign up today ✍\uFE0F and start managing your farm \uD83D\uDE9C and marketplace \uD83D\uDED2 in one place!",
                            color = textColor,
